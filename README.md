<!-- DEMO profile README for magikh0e/magikh0e — terminal / cyberpunk style.
     This is a local demo, not pushed anywhere. Preview by dropping it in a
     repo named magikh0e/magikh0e, or any Markdown previewer. -->

```
 _ __ ___   __ _  __ _(_) | _____ |___ / ___
| '_ ` _ \ / _` |/ _` | | |/ / _ \  |_ \/ _ \
| | | | | | (_| | (_| | |   < (_) |___) |  __/
|_| |_| |_|\__,_|\__, |_|_|\_\___/|____/ \___|
                 |___/
